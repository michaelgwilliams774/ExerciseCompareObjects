...
var user2_temp = {org: "dev", name: "nerd"}
// simple, but limited solution when the order of properties are different
...
console.log(deepCompare(user1, user2))
console.log(deepCompare(user1, user2_temp))